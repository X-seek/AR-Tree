...
(function () {
  ...
  function applyStaticTranslations() {
    ...
    if (titleEl) titleEl.textContent = get(translations[currentLang], "page.title") || titleEl.textContent;
  }
  ...
  // auto apply when DOM ready (if loaded after fragments)
