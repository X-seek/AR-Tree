  ...
  const translations = {
    th: {
      ...
      hotspot: {
        ...
        leaf: {
          title: "ใบ",
          desc: `<div class="content-box">เป็นใบเดี่ยวค่อนข้างหนา ขอบใบหยัก 3-5 หยัก หรือตรงผิวใบด้านบนหยาบ<br><br>
          <b>สรรพคุณ :</b>
          <ul class="desc">
        ...
        fruit: {
          title: "ผล",
          desc: `<div class="content-box">ผลไม้ลูกเล็ก ๆ ที่มีเนื้อด้านในเป็นสีแดงเข้ม เมื่อสุกได้ที่จะมีรสชาติหวาน หอมละมุน และเนื้อละเอียด ซึ่งเป็นอีกหนึ่งผลไม้ที่ได้รับความนิยมอย่างมากในหมู่คนรักสุขภาพ<br><br>
        ...
        root: {
          title: "ราก",
          desc: `<div class="content-box">มะเดื่อฝรั่งชอบความชื้น แต่ไม่ทนต่อการมีน้ำขัง ซึ่งอาจทำให้เกิดโรครากเน่าได้ง่าย<br><br>
          <b>สรรพคุณ :</b> ใช้แก้ไข้ กระทุ้งพิษไข้ กล่อมเสมหะและเลือด แก้ไข้หวัด แก้ไข้กาฬ และไข้พิษทุกชนิด<br><br>
          <b>การเสริมราก :</b> ในไทยนิยมเสริมรากด้วยตอมะเดื่ออุทุมพร (มะเดื่อไทย) เนื่องจากรากอุทุมพรมีความแข็งแรง ทนทานต่อโรค และช่วยให้ต้นมะเดื่อฝรั่งเจริญเติบโตได้ดี ให้ผลดกกว่าการใช้รากเดิม</div>`,
          reference: `
        ...
        Cultivation_and_Care: {
          ...
          <b>การใส่ปุ๋ย :</b> บำรุงด้วยปุ๋ยสูตรเสมอ 15-15-15 หรือ 16-16-16 สลับกับการให้ปุ๋ยหมักเดือนละครั้ง ซึ่งการบำรุงก็ขึ้นอยู่กับดินที่ปลูกหรือวัสดุที่ใช้ปลูกหากมีธาตุอาหารเพียงพอก็ไม่ต้องบำรุงมาก</div>`,
          reference: `
    ...
    en: {
      ...
      hotspot: {
        stem: {
          ...
          and itching, and to cleanse and staunch bleeding wounds; it also serves as an antiemetic.</div>`,
        ...
        leaf: {
          title: "Leaf",
          desc: `<div class="content-box">The fig leaf is a single, comparatively thick blade with three to five lobes or indentations along the 
          ...
          suppressing the growth of colon cancer cells.</div>`,
        ...
        fruit: {
          title: "Fruit",
          desc: `<div class="content-box">The fig is a small fruit with a deep red interior that, upon reaching full ripeness, 
          ...
          to treat diarrhoea, to staunch bleeding, to cleanse and heal wounds, and to relieve skin rashes and itching.</div>`,
        ...
        root: {
          title: "Root",
          desc: `<div class="content-box">The fig tree prefers moist conditions, yet it does not tolerate waterlogging, which may readily give rise to root rot.<br><br>
