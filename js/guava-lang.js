  ...
  const translations = {
    ...
    en: {
      ...
      hotspot: {
        trunk: {
          title: "Stem",
          desc: `The guava is a small, shrubby perennial tree with a rounded crown, attaining a height of approximately 3 
        ...
        leaf: {
          title: "Leaf",
          desc: `The leaf is paired, with young leaves being green and covered with fine hairs on a slightly uneven surface. 
          Leaves emerge in pairs from opposite sides of the branch. The upper surface is deeply grooved; the blade is
           ...
           from ingrown toenails, and to treat mosquito bites.`,
        ...
        fruit: {
          title: "Fruit",
          desc: `The fruit is round or ovoid in form, prominently tapering at the apex, with a diameter 
