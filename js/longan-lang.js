    ...
    th: {
      ...
      hotspot: {
        stem: {
          ...
          <b>ประโยชน์</b><br>เปลือกต้มดื่มแก้ท้องร่วง ท้องเสีย และใช้สมานแผล ไฟไหม้ และน้ำร้อนลวก ส่วนเนื้อไม้ใช้ทำเฟอร์นิเจอร์ ครก เขียง หรือเป็นไม้ฟืนรมควันชั้นดี เพราะให้ความร้อนสูงและควันมีกลิ่นหอมเป็นเอกลักษณ์</div>`,
        ...
        leaf: {
          title: "ใบ",
          desc: `<div class="content-box">เป็นใบประกอบแบบขนนก ใบย่อยรูปรีแกมรูปหอก<br><br>

          <b>สรรพคุณ : </b> ต้มดื่มเป็นชาแก้หวัด ไข้มาลาเรีย บรรเทาริดสีดวงทวาร หรือใช้ต้มชะล้างแผลเปื่อย แผลหนอง ฝี</div>`,
        ...
        Cultivation_and_Care: {
          ...
          <b>ศัตรูพืช :</b> มวนลำไย ดูดน้ำเลี้ยงจนผลดำร่วง, เพลี้ยแป้ง มีมดเป็นพาหะ ทำให้เกิดโรคราดำ, หนอนกินใบ ทำลายยอดอ่อนและดอก</div>`,
          reference: `
    ...
    en: {
      ...
      hotspot: {
        stem: {
          ...
          intense heat and emits a characteristically pleasant and distinctive aroma.</div>`,
        ...
        leaf: {
          title: "Leaf",
          desc: `<div class="content-box">The leaf is a pinnately compound leaf with lanceolate-elliptical leaflets.<br><br>
  
          <b>Medicinal Properties : </b>A decoction of the leaves, consumed as a tea, is prescribed to treat common colds and 
          malarial fever, and to relieve haemorrhoids. The decoction may also be applied externally to cleanse suppurating wounds, abscesses, and boils.</div>`,
        ...
        fruit: {
          title: "Fruit",
          desc: `<div class="content-box">The longan produces inflorescences of small, white to yellowish flowers with a pleasant fragrance. The plant 
          ...
          <ul class="desc">
         <li> Per 100 grams of edible portion, longan provides: 60 kilocalories of energy; 0.1 grams of fat; 15.1 grams of carbohydrates;
           1.1 grams of dietary fibre; 1.31 grams of protein; 1 milligram of calcium; 21 milligrams of phosphorus; 0.13 milligrams of 
           iron; 0.3 milligrams of niacin; and 84 milligrams of vitamin C.</li>
          </ul>
        ...
        root: {
          title: "Root",
          desc: `<div class="content-box">Trees grown from seed possess a robust and deeply penetrating taproot. Trees propagated by air-layering lack a taproot and 
        ...
        Cultivation_and_Care: {
          ...
          give rise to sooty mould disease. Leaf-eating caterpillars damage young shoots and flowers.</div>`,
