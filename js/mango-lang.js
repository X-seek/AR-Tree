...
`,
        ...
        fruit: {
          title: "ผล",
          desc: `มะม่วงดิบมีรสชาติเปรี้ยว มีวิตามิน C สูง ช่วยป้องกันหวัดและโรคเลือดออกตามไรฟันได้ (ลักปิดลักเปิด) นอกจากนี้ยังมีสารต้านอนุมูลอิสระสูง มะม่วงสุกมีรสชาติหวาน 
          เนื้อนุ่ม มีวิตามิน A และเบต้าแคโรทีนสูงช่วยในการบำรุงสายตา ทำให้มองในเวลากลางคืนดีขึ้น และช่วยบำรุงผิว<br><br>
<b>สรรพคุณ :</b> มีกากใยอาหารที่สูง ช่วยในการขับถ่าย (มะม่วงสุกเป็นยาระบายอ่อน ๆ) และช่วยแก้อาการวิงเวียนศีรษะ คลื่นไส้อาเจียน มีสารต้านอนุมูลอิสระ ลดความเสี่ยงมะเร็ง (เช่น มะเร็งเต้านม, ลำไส้) และช่วยบำรุงหัวใจ
<br><br>
...
`,
        ...
        care: {
          title: "การดูแล",
          desc: `<b>สภาพแวดล้อม :</b> ต้นมะม่วงต้องการสภาพอากาศอบอุ่น และแสงแดดเต็มที่ (อย่างน้อย 6 ชั่วโมงต่อวัน) และชอบดินที่ลึกและระบายน้ำได้ดี
<br><br>
