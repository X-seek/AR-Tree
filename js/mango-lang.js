  ...
  const translations = {
    th: {
      ...
      hotspot: {
        trunk: {
          title: "ลำต้น",
          desc: `เป็นไม้ยืนต้นขนาดใหญ่ เนื้อไม้สามารถนำไปทำเฟอร์นิเจอร์ได้
<br><br>
...
`,
        ...
        leaf: {
          title: "ใบ",
          desc: `นำใบสดมาตำพอกแผลสด เพื่อสมานแผล และล้างบาดแผลภายนอกได้ ส่วนใบแห้งใช้ต้มดื่ม แก้ท้องร่วง/ลำไส้อักเสบเรื้อรัง นอกจากนี้ยังมีตำราพื้นบ้านใช้ต้มดื่ม แก้สะอึกได้
<br><br>
<b>ข้อควรระวัง :</b> ไม่ควรเคี้ยวใบสด เพราะน้ำยางมะม่วง อาจกัดปากได้ หากจะใช้ควรนำไปต้มก่อน
`,
        },
        fruit: {
          title: "ผล",
          desc: `มะม่วงดิบมีรสชาติเปรี้ยว มีวิตามิน C สูง ช่วยป้องกันหวัดและโรคเลือดออกตามไรฟันได้ (ลักปิดลักเปิด) นอกจากนี้ยังมีสารต้านอนุมูลอิสระสูง มะม่วงสุกมีรสชาติหวาน เนื้อนุ่ม 
          มีวิตามิน A และเบต้าแคโรทีนสูงช่วยในการบำรุงสายตา ทำให้มองในเวลากลางคืนดีขึ้น และช่วยบำรุงผิว
<br><br>
<b>สรรพคุณ :</b> มีกากใยอาหารที่สูง ช่วยในการ ขับถ่าย (มะม่วงสุกเป็นยาระบายอ่อนๆ) และช่วยแก้อาการ วิงเวียนศีรษะ คลื่นไส้อาเจียน
<br><br>
...
`,
        ...
        root: {
          title: "ราก",
          desc: `เป็นรากแก้วที่สามารถชอนไชลงดินได้ลึกถึง 6 เมตร แต่รากจะดูดซึมอยู่หนาแน่นที่บริเวณผิวดิน (ลึก 30 - 60 ซม.) และแผ่บริเวณกว้าง
<br><br>
...
`,
        ...
        care: {
          title: "การดูแล",
          desc: `<b>สภาพแวดล้อม :</b> ต้นมะม่วงต้องการสภาพอากาศอบอุ่นและแสงแดดเต็มที่ (อย่างน้อย 6 ชั่วโมงต่อวัน) และชอบดินที่ลึกและระบายน้ำได้ดี
<br><br>
<b>การให้น้ำ :</b> : ต้นอ่อนต้องการน้ำมากในช่วงแรก แต่ต้นที่โตเต็มที่สามารถทนต่อความแห้งแล้งได้บางส่วน แต่ควรรดน้ำสม่ำเสมอในช่วง 1 ปีแรก และก่อน/หลังการราดสารกระตุ้นดอก
<br><br>
<b>การตัดแต่งกิ่ง :</b> จำเป็นต้องตัดแต่งกิ่งอย่างสม่ำเสมอ เพื่อให้ทรงพุ่มโปร่ง อากาศถ่ายเทได้สะดวก และเพื่อกระตุ้นการผลิตผล
<br><br>
